...
pub struct VersionProjectCustomField {
    ...
    pub bundle: Option<Box<models::VersionBundle>>,
    #[serde(rename = "defaultValues", skip_serializing_if = "Option::is_none")]
    pub default_values: Option<Vec<models::VersionBundleElement>>,
}

impl VersionProjectCustomField {
    /// Represents project settings for a version field.
    pub fn new() -> VersionProjectCustomField {
