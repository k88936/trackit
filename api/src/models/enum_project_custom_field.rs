...
pub struct EnumProjectCustomField {
    ...
    pub bundle: Option<Box<models::EnumBundle>>,
    #[serde(rename = "defaultValues", skip_serializing_if = "Option::is_none")]
    pub default_values: Option<Vec<models::EnumBundleElement>>,
}

impl EnumProjectCustomField {
    /// Represents project settings for the enum field.
    pub fn new() -> EnumProjectCustomField {
