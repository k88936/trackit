...
pub struct StateProjectCustomField {
    ...
    pub bundle: Option<Box<models::StateBundle>>,
    #[serde(rename = "defaultValues", skip_serializing_if = "Option::is_none")]
    pub default_values: Option<Vec<models::StateBundleElement>>,
}

impl StateProjectCustomField {
    /// Represents project settings for a state field.
    pub fn new() -> StateProjectCustomField {
